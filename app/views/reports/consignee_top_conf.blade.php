@extends('layouts/default', ['vuePage' => 'consignee-top-conf'])
...
@section('content')
	...
	<h3 class="page-title">
		Top Consignee <small>report</small>
	</h3>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form @submit.prevent="onSubmit" action="{{ route('reports.misc.consignee.top.rpt') }}">
