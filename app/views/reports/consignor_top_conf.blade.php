@extends('layouts/default', ['vuePage' => 'consignor-top-conf'])
...
@section('content')
	...
	<h3 class="page-title">
		Top Consignor <small>report</small>
	</h3>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form @submit.prevent="onSubmit" action="{{ route('reports.misc.consignor.top.rpt') }}">
