@extends('layouts/default', ['vuePage' => 'cargo-containerized-mt-conf'])
...
@section('content')
	...
	<h3 class="page-title">
		Total Containerized Cargo MT <small>report</small>
	</h3>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form @submit.prevent="onSubmit" action="{{ route('reports.cargo.containerized.mt.rpt') }}">
