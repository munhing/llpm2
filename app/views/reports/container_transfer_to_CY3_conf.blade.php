@extends('layouts/default', ['vuePage' => 'container-transfer-to-CY3-conf'])
...
@section('content')
    ...
    <h3 class="page-title">
        Total Container Transfer from CY1 to CY3 <small>report</small>
    </h3>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form @submit.prevent="onSubmit" action="{{ route('reports.container.transfer.to.CY3.rpt') }}">
