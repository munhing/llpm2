@extends('layouts/default', ['vuePage' => 'cargo-origin-conf'])
...
@section('content')
	...
	<h3 class="page-title">
		Top Country for Import Cargo <small>report</small>
	</h3>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form @submit.prevent="onSubmit" action="{{ route('reports.cargo.origin.rpt') }}">
