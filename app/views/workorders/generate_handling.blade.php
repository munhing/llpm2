...
<?php $page_total = ceil(count($containerList) / 35); ?>
<?php $no = 1; ?>
<?php  $container_chunk = array_chunk($containerList->toArray(), 35, true) ?>
...
@for ($page_counter = 1; $page_counter < ($page_total + 1); $page_counter++)
	...
	<div id="wrapper">
		...
		<div id="header">
			...
			<div class="row">
				<div class="col-xs-12">
					<h1 class="text-left no-margin"><b>Handling Charges</b>
						<span class="muted">
							# {{ $workOrder->id }} | {{ $movement[$workOrder->movement] }}	
						</span>
					</h1>
				</div>
				...
				<div class="col-xs-12">
					<div class="invoice-payment">
						<ul class="list-unstyled">
							<li>
								<strong>Total Charges:</strong> {{ number_format($total_charges, 2) }} | <strong>Date:</strong> {{ $workOrder->date->toFormattedDateString() }}
							</li>
							<li>
