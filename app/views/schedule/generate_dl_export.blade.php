...
<body>
	...
	<div id="wrapper">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="invoice-payment">
						<ul class="list-unstyled">
							<li>
								<strong>Consignor:</strong> {{ $cargo->consignor->name }}
							</li>
							<li>
								<strong>Vessel:</strong> {{ $schedule->vessel->name }} v.{{ $schedule->voyage_no_departure }}
							</li>
							<li>
								<strong>Date of Departure:</strong> {{ $schedule->etd->format('d/m/Y') }}
							</li>
						</ul>
					</div>				
				</div>
		...
		<div id="footer">
			...
			<div class="row">
				<div class="col-xs-12">
					Date DL Issued: {{ $cargo->issued_date->format('d/m/Y') }}
				</div>
			</div>
